...
For this exercise, start by forking [this empty project](https://hytop.onrender.com/e/web). Then, follow the instructions below to build a little text-based JavaScript program. The program will ask the user a number of questions, and then display some information using the answers the user provides.
